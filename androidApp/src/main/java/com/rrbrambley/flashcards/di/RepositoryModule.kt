...
object RepositoryModule {
    ...
    @Provides
    fun provideFlashcardRepository(apiClient: FlashcardApiClient, flashcardDao: FlashcardDao): FlashcardRepository =
        FlashcardRepositoryImpl(apiClient, flashcardDao)
